"""Vendored S&P 500 constituent list (analysis universe for #5).

A fixed reference universe decouples *what we analyze* from *what social media
happens to be talking about*: every name here can be screened and recommended
even with zero social mentions, and social activity becomes a prioritization
overlay rather than the gatekeeper.

Static on purpose -- no network dependency at runtime, fully reproducible, and
trivially diffable. Symbols use yfinance form (e.g. ``BRK-B``, not ``BRK.B``).
Refresh by re-running the vendoring step documented in the README.

Source: S&P 500 constituents (datasets/s-and-p-500-companies),
vendored 2026-06-25 (503 symbols).
"""
...
SP500: tuple[str, ...] = (
    ...
    "HWM", "IBKR", "IBM", "ICE", "IDXX", "IEX", "IFF", "INCY", "INTC", "INTU",
    "INVH", "IP", "IQV", "IR", "IRM", "ISRG", "IT", "ITW", "IVZ", "J", "JBHT",
    "JBL", "JCI", "JKHY", "JNJ", "JPM", "KDP", "KEY", "KEYS", "KHC", "KIM",
    "KKR", "KLAC", "KMB", "KMI", "KO", "KR", "KVUE", "L", "LDOS", "LEN", "LH",
